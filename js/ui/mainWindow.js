...
import { openBackendSearchDialog } from './dialogs.js';
...
export function renderMainWindow() {
  ...
  <header class="top-bar" style="height:8vh;">
    <div class="top-bar-left">
      <div class="top-bar-logo" style="width:12%; min-width:180px; max-width:220px; display:flex; align-items:center;">
        <img src="assets/mugenlist-logo.svg" alt="MugenList Logo" style="width:100%; height:auto; object-fit:contain; display:block;">
      </div>
    </div>
  ...
  // Add Anime → open backend-driven search dialog (modal)
  document.getElementById('top-add-btn')?.addEventListener('click', () => {
    openBackendSearchDialog();
  });
