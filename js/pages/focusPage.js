...
export function render(container, params = {}) {
  ...
  const isAiringRoot = displayAnime.status === 'Currently Airing' || selectedSeason?.status === 'Currently Airing';
          ...
          <div class="focus-hero-content">
            ...
            <div class="focus-meta">
              ...
              <div class="focus-stats-row">
                <span class="badge-${rootStatus}" style="padding:3px 10px;border-radius:9999px;font-size:0.8rem;font-weight:600;">${statusLabel(rootStatus, isAiringRoot)}</span>
      ...
      row.innerHTML = `
        ...
        <div style="flex:1;min-width:0;">
          ...
          <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:6px;">
            <span class="badge-${normalizeStatus(season.watch_status)}" style="padding:1px 6px;border-radius:9999px;font-size:0.65rem;font-weight:700;text-transform:uppercase;">${statusLabel(normalizeStatus(season.watch_status), isAiring)}</span>
