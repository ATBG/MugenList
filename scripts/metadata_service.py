...
class MetadataService:
    ...
    def search_jikan(self, query: str) -> List[Dict[str, Any]]:
        """Search anime via Jikan."""
        data = self._request("GET", f"{JIKAN_BASE}/anime", params={"q": query, "limit": 10})
        if data and "data" in data:
            return data["data"]
        return []
    ...
    def get_anilist_media(self, id_mal: int) -> Optional[Dict[str, Any]]:
        """Fetch media details from AniList via MAL ID."""
    ...
    def get_simkl_anime(self, id_mal: int) -> Optional[Dict[str, Any]]:
        ...
        client_id = os.environ.get(
            "SIMKL_CLIENT_ID",
            "f26284a14f6b801550979a0220627e7f677d24f0a202d09c2a61b8f5228518e3"
        )
